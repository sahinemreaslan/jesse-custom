"""
MOMENTUM GUARDIAN - OPTİMİZASYON VE DETAYLI ANALİZ
═══════════════════════════════════════════════════════════
Amaç: 100/100 skor alan Momentum Guardian stratejisini
      4 adımlı testten geçir ve optimize et

Strateji Özellikleri:
  - Giriş: Sadece Trending Up (en güçlü trend)
  - Min Strength: 40 (yüksek filtre)
  - Position Size: %12
  - Momentum Exit: %40 momentum kaybında çık
  - Trailing Stop: %7'de aktif, %2.5 mesafe
═══════════════════════════════════════════════════════════
"""
import sys
...
def main():
    """Ana test fonksiyonu"""
    print("="*80)
    print("MOMENTUM GUARDIAN - DETAYLI ANALİZ")
    print("="*80)
    print("\n🏆 Scanner Skoru: 100/100")
    print("📊 Özellik: Momentum-based exit ile risk yönetimi")
    print("\n" + "="*80)
    ...
    # Momentum exit analizi
    momentum_exits = exit_reasons.get('Momentum Loss', 0)
    if momentum_exits > 0:
        print(f"\n💪 MOMENTUM EXIT ETKİSİ:")
        print(f"   Momentum kaybında erken çıkış: {momentum_exits} işlem")
        print(f"   Bu özellik zarar limitlemede yardımcı oluyor!")
